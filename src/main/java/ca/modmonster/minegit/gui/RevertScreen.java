...
public class RevertScreen extends Screen {
    ...
    protected void init() {
        ...
        scrollable = new ScrollableLayout(minecraft, commitsColumn, 0);
    ...
    private void revert() {
        ...
        new Thread(() -> {
            ...
            minecraft.getToastManager().addToast(new SystemToast(new SystemToast.SystemToastId(), Component.translatable("minegit.revert.complete"), null));
