...
public class CloneScreen extends Screen {
    ...
    private void doClone() {
        ...
        new Thread(() -> {
            ...
            minecraft.submit(() -> {
                if (result == 0) {
                    SystemToast.add(minecraft.gui.toastManager(), new SystemToast.SystemToastId(), Component.translatable("minegit.clone.success", ConfigManager.getCurrentConfig().gitService.getNaturalName()), null);
